...
<div class="content">
   ...
   <tr align="center">   
   	    ...
   	    <tr align="center">
   	    	...
   	    	<td>
   	    		<!-- <input type="text" name="scat" class="text"> -->
...
if(isset($_POST['s']))
{
		...
		$a=mysqli_query($con,"insert into menu(category,sub_cat,title,description,price,image) values('$cat','$scat','$title','$det','$price','$i')") or die(mysqli_error($con));
		...
		{
			echo "<div style='text-align:center; font-size:1.3em; color:red;'>Data unapload</div>";
		}
}
?>	
</div>
